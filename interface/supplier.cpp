...
void supplier::on_pushButton_add_provider_clicked()
{
...
void supplier::on_pushButton_modify_provider_clicked()
{
...
void supplier::on_pushButton_delete_providert_clicked()
{
    QString id = ui->lineEdit_id_modify->text();
...
void supplier::on_recherche_clicked()
{
    Provider ptmp;
...
void supplier::on_pushButton_sort_providers_clicked()
{
...
void supplier::on_pushButton_Stat_clicked()
{
...
void supplier::on_pushButton_add_provider_5_clicked()
{
    QPdfWriter pdf("C:/Users/MSI/Desktop/PDF_Fournisseurs.pdf");
...
void supplier::on_pushButton_location_clicked()
{
    QString link="https://www.google.com/maps/@36.8800893,10.1927418,14z";
